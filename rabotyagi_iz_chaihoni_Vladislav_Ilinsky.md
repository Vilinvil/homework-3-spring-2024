...
После завершения создания проверяем необходимое название в списке, нажимаем редактировать и еще раз проверяем что поля,
которые мы вводили, корректно сохранились.
